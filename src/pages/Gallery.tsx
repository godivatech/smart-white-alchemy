...
const Gallery = () => {
  ...
  const galleryImages = [
    { id: 1, src: '/images/gallery-1.jpg', alt: 'Modern Fade Cut', categories: ['haircuts'] },
    { id: 2, src: '/images/gallery-2.jpg', alt: 'Precision Beard Trim', categories: ['beards'] },
    { id: 3, src: '/images/gallery-3.jpg', alt: 'Platinum Blonde Color', categories: ['color'] },
    { id: 4, src: '/images/gallery-4.jpg', alt: 'Relaxing Head Massage', categories: ['spa'] },
    { id: 5, src: '/images/gallery-5.jpg', alt: 'Classic Gentleman Cut', categories: ['haircuts'] },
    { id: 6, src: '/images/gallery-6.jpg', alt: 'Full Beard Styling', categories: ['beards'] },
    { id: 7, src: '/images/gallery-7.jpg', alt: 'Highlights & Texture', categories: ['color'] },
    { id: 8, src: '/images/gallery-8.jpg', alt: 'Facial Treatment', categories: ['spa'] },
    { id: 9, src: '/images/gallery-9.jpg', alt: 'Undercut Design', categories: ['haircuts'] },
    { id: 10, src: '/images/gallery-10.jpg', alt: 'Beard & Mustache Detail', categories: ['beards'] },
    { id: 11, src: '/images/gallery-11.jpg', alt: 'Natural Hair Color', categories: ['color'] },
    { id: 12, src: '/images/gallery-12.jpg', alt: 'Hot Towel Service', categories: ['spa'] }
  ];
  ...
  return (
    <div className="pt-20">
      ...
      {/* CTA Section */}
      <section className="relative py-20 bg-cover bg-center" style={{ backgroundImage: 'url(/images/gallery-cta.jpg)' }}>
        <div className="absolute inset-0 bg-salon-black/80"></div>
        <div className="page-container relative z-10 text-center">
